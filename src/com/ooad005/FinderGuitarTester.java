...
public class FinderGuitarTester {
	...
	private static void initializeInventory(Inventory inventory) {
		inventory.addGuitar(null, 999, new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 8));
		inventory.addGuitar(null, 111, new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 8));
	}
}
