...
public class FinderGuitarTester {
	public static void main(String[] args) {
		...
		GuitarSpec whatErinLikes = new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 8);
	...
	private static void initializeInventory(Inventory inventory) {
		inventory.addInstrument(null, 999, new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 8));
		inventory.addInstrument(null, 111, new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 8));
	}
}
